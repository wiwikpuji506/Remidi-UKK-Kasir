    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2></b>Data Detail Penjualan</b></h2></div>
                    <div class="col-sm-4">
                    </div>
                </div>
            </div>
            <p><a href="tambahdetailpenjualan.php" class="tambah" title="Tambah" data-toggle="tooltip">+ Tambah Detail Penjualan</a></p>
            ...
            <form action="" method="post">
              ...
              <select name="pilih">
                ...
                <option value="JumlahProduk">JumlahProduk</option>
            ...
            <thead>
<tr>
<th>DetailID</th> <th>PenjualanID</th> <th>ProdukID</th> <th>JumlahProduk</th><th>SubTotal</th> <th>OPSI</th>
<?php
include "koneksi.php";
$tampil = "";
if (isset($_POST['cari'])) {
...
foreach ($tampil as $row) {
 ...
 <td><?php echo $row['SubTotal']; ?></td>
                    ...
                    <td>
                    <a href="editdetailpenjualan.php?DetailID=<?php echo $row['DetailID']?>">Edit</a> |
                    <a href="hapusdetailpenjualan.php?DetailID=<?php echo $row['DetailID']?>">Delete</a>
 </td>
                    </tr>
                <?php
                }
