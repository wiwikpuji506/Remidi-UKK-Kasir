        ...
        <div class="table-wrapper">
            ...
            <form action="" method="post">
              ...
              <select name="pilih">
                ...
                <option value="TanggalPenjualan">TanggalPenjualan</option>
                <option value="TotalHarga">TotalHarga</option>
            ...
            <thead>
<tr>
<th>PenjualanID</th> <th>TanggalPenjualan</th> <th>TotalHarga</th> <th>OPSI</th>
<?php
include "koneksi.php";
$tampil = "";
if (isset($_POST['cari'])) {
...
foreach ($tampil as $row) {
 ...
 <td><?php echo $row['TotalHarga']; ?></td>
                    ...
                    <td>
                    <a href="editpenjualan.php?PenjualanID=<?php echo $row['PenjualanID']?>">Edit</a> |
                    <a href="hapuspenjualan.php?PenjualanID=<?php echo $row['PenjualanID']?>">Delete</a>
 </td>
                    </tr>
                <?php
                }
