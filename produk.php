...
<div class="container-xl">
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <p><a href="tambahproduk.php" class="tambah" title="Tambah" data-toggle="tooltip">+ Tambah Data Produk</a></p>
...
foreach ($tampil as $row) {
 ...
 <td><?php echo $row['Stok']; ?></td>
                    ...
                    <td>
                    <a href="editproduk.php?ProdukID=<?php echo $row['ProdukID']?>">Edit</a> |
                    <a href="hapusproduk.php?ProdukID=<?php echo $row['ProdukID']?>">Delete</a>
 </td>
                    </tr>
                <?php
                }
